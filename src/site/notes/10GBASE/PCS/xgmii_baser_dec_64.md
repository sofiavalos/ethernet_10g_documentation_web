...
| xgmii_rxd         | output    | wire [DATA_WIDTH-1:0] | Salida de datos para [[Abbreviations#XGMII\|XGMII]]   |
| xgmii_rxc         | output    | wire [CTRL_WIDTH-1:0] | Salida de control para [[Abbreviations#XGMII\|XGMII]] |
...
| xgmii_rxd_reg = {DATA_WIDTH{1'b0}} | reg [DATA_WIDTH-1:0] | Registro para almacenar la salida de datos de [[Abbreviations#XGMII\|XGMII]]   |
| xgmii_rxd_next                     | reg [DATA_WIDTH-1:0] | Registro para almacenar la salida de datos de [[Abbreviations#XGMII\|XGMII]]   |
| xgmii_rxc_reg = {CTRL_WIDTH{1'b0}} | reg [CTRL_WIDTH-1:0] | Registro para almacenar la salida de control de [[Abbreviations#XGMII\|XGMII]] |
| xgmii_rxc_next                     | reg [CTRL_WIDTH-1:0] | Registro para almacenar la salida de control de [[Abbreviations#XGMII\|XGMII]] |
